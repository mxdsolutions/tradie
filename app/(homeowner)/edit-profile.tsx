...
export default function EditProfileScreen() {
    ...
    const loadUserData = async () => {
        try {
            ...
            if (data) {
                ...
                setPhone(data.phone || ''); // Assuming phone column exists or we add it
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // if (refreshUser) await refreshUser(); // Refresh context if available
            ...
            <ScrollView className="flex-1" contentContainerStyle={{ padding: 24 }}>
                ...
                <View className="items-center mb-8">
                    <View className="relative">
                        ...
                        <TouchableOpacity
                            onPress={pickImage}
                            className="absolute bottom-0 right-0 bg-primary p-2.5 rounded-full border-2 border-white shadow-md active:scale-95 transition-all"
                        >
                            {/* @ts-ignore */}
                ...
                <View className="space-y-6">
                    <View className="flex-row gap-4">
                        <View className="flex-1">
                            ...
                            <TextInput
                                ...
                                className="bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-base text-slate-900 font-medium h-14"
                            />
                        </View>
                        <View className="flex-1">
                    ...
                    <View>
                        ...
                        <TextInput
                            value={email}
                            editable={false}
                            className="bg-slate-100 border border-slate-200 rounded-xl px-4 py-3.5 text-base text-slate-500 font-medium h-14"
                        />
                    </View>
