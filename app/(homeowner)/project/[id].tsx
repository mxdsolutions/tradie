...
import { ArrowLeftIcon, CalendarDaysIcon, CheckCircleIcon, CurrencyDollarIcon, DocumentTextIcon, MapPinIcon, WrenchScrewdriverIcon, ChatBubbleLeftRightIcon } from 'react-native-heroicons/outline';
    ...
    const fetchProjectDetails = async () => {
        try {
            ...
            const { data: milestonesData, error: milestonesError } = await supabase
                ...
                .select('*')
                .eq('project_id', id)
                .order('date', { ascending: true }); // Approximating order by date if order_index is null
        ...
        <View className="flex-1 bg-background">
            ...
            >
                <View className="flex-row items-center justify-between mb-6">
                    ...
                    <Typography variant="h2" className="text-white font-bold">Project Details</Typography>
                    {project.chat_id && (
                        <TouchableOpacity
