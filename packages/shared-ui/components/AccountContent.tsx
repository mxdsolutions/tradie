...
import { ArrowLeftOnRectangleIcon, ChevronRightIcon, UserIcon, Cog6ToothIcon, QuestionMarkCircleIcon, BellIcon, CheckBadgeIcon } from 'react-native-heroicons/outline';
...
export default function AccountContent() {
    const { userMode, signOut, user } = useUser();
        ...
        >
            ...
            <View className="px-6">
                <View className="bg-white rounded-2xl overflow-hidden border border-slate-100">
                    ...
                    {userMode === 'tradie' && (
                        /* @ts-ignore */
                        <MenuItem icon={CheckBadgeIcon} label="Licences" onPress={() => router.push('/licences')} />
                    )}
                </View>
